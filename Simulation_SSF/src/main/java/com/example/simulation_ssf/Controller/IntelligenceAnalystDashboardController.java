...
//            Stage currentStage = (Stage) dashboardButton.getScene().getWindow();
    ...
    public void SuspiciousActivitiesButtonOnAction(ActionEvent actionEvent) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(SSFApplication.class.getResource("/com/example/simulation_ssf/IntelligenceAnalystGoals/Goal5_Monitorsuspiciousactivitesstored.fxml"));
